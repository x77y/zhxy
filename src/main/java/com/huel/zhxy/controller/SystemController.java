...
import static com.huel.zhxy.util.Result.fail;
...
public class SystemController {
    ...
    public Result headerImgUpload(
        ...
        String portraitPath = "C:/IdeaCode/zhxy/target/classes/public/upload/".concat(newFileName);
        try {
    ...
    public Result updatePwd(
        ...
        switch (userType) {
            ...
            case 2:
                ...
                Student stu = studentService.getOne(queryWrapper2);
